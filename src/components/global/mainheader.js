  ...
  render() {
    ...
    return (
      <div className="MainHeader">
        ...
        <div className="MainNavHeader mr-auto">Vocabulary.Trainer</div>
          <ul className="MainNavList ml-auto">
            <li className="MainNavItem"><FontAwesomeIcon icon={faSignInAlt} /><div className="NavItemText">Sign in</div></li>
            ...
            <li className="MainNavItem"><FontAwesomeIcon icon={faFacebook} /><div className="NavItemText">Facebook</div></li>
